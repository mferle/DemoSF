CREATE OR REPLACE TABLE PUBLIC.UTL_DIM_TIME (
	Date_Time TIMESTAMP_NTZ,
	Date_ID INTEGER
);

INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2006-02-20 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20060220);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2006-02-21 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20060221);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2006-06-04 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20060604);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2010-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20100101);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2010-01-02 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20100102);

INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2024-12-29 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20241229);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2024-12-30 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20241230);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2024-12-31 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20241231);
INSERT INTO PUBLIC.UTL_DIM_TIME VALUES (to_timestamp('2025-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 20250101);

SELECT * FROM PUBLIC.UTL_DIM_TIME;

CREATE OR REPLACE VIEW PUBLIC.DIM_TIME
AS
SELECT t.*, 
...
FROM (
	...
	--	,CASE WHEN JEW.Half_Day_Ind = 1 THEN 'יום חלקי'
	--	ELSE 'יום מלא' END AS Half_Day_Ind_Name
 --       ,ISNULL(JEWISH.Holiday_Per_Week_Name,'-') AS Holiday_Per_Week_Name
	...
	LEFT OUTER JOIN [Admin].[Dim_Time_Month_Properties] AS MNTH ON MONTH(DAYS.DATE_TIME) = MNTH.MonthOfYear_ID
